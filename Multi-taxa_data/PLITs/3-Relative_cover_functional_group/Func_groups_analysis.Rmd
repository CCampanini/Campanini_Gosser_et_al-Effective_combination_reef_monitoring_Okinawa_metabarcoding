...
func_mean_depth<- func_mean_depth %>%
  rename(Abbr = Site)


func_mean_depth <- func_mean_depth %>%
  mutate(Site = case_when(
    endsWith(Abbr, "AW") ~ "Awa",
    endsWith(Abbr, "SN") ~ "Sunabe",
    endsWith(Abbr, "ZA") ~ "Zatsun",
    endsWith(Abbr, "HI") ~ "Hizushi",
    ))


func_mean_depth$Site<-ordered(func_mean_depth$Site,
                            levels=c("Awa","Sunabe","Zatsun","Hizushi"))
str(func_mean_depth)
