...
hc_mean_depth$Functional_group[hc_mean_depth$Functional_group == "plate"] <- "solitary"
...
```{r}
func_mat_primer <- data.frame(t(func_mat))
func_mat_primer$Category <- colnames(func_mat)
func_mat_primer <- func_mat_primer[,c(70,1:69)]
```
...
ind_df_primer <- ind_df_primer[,c(6,2,3,5,7)] # remove transect, replicate and reorder
...
openxlsx::write.xlsx(list("func_mat_primer" = func_mat_primer,
