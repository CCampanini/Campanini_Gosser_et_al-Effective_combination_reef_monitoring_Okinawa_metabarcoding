...
mean_rel_cov_site <- mean_rel_cov_site[,c(1,14,2:13)]
mean_rel_cov_site
```
...
mean_rel_cov_site <- mean_rel_cov_site %>%
  mutate(Site = case_when(Site == 'hi' ~ "HI" | 
                              Site == "S1" | 
                              Site == "S2" |
                              Site == "ZP" ~ "Low", 
                              Site == 'ZA' | 
...
mean_rel_cov_wide <- dcast(mean_rel_cov_df, Site_depth ~ Category, value.var = "Mean_rel_cov")
mean_rel_cov_wide
