...
Display input matrix and data frame with independent variables
...
#ALTERNATIVE SCRIPT WITH adonis2()
set.seed(69)
h <- how(nperm = 9999, blocks = ind_df$pressure)
inv_permanova <- adonis2(inv_mat ~ pressure/site*depth,
                             data=ind_df,
                             permutations =h,
                             methods="bray")
...
set.seed(69)
h <- how(nperm = 9999)
inv_permanova <- adonis2(inv_mat ~ depth*(pressure/site),
                             data=ind_df,
                             permutations =h,
                             methods="bray")
...
```{r}
inv_bd_pressure = betadisper(inv_dist, ind_df$pressure)  #Implements Marti Anderson's PERMDISP2 procedure for the analysis of multivariate homogeneity of group dispersions (variances). betadisper is a multivariate analogue of Levene's test for homogeneity of variances 
str(inv_bd_pressure)
